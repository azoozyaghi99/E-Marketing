                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">اضافة منتج</h3>
                        </div>
                    </div>
                </div>
                <!--begin::Form-->
                <form method="post" action="{{ route('product.store') }}" class="m-form m-form--fit m-form--label-align-right">
                    @csrf
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-10">
                                <input name="price" class="form-control m-input" type="number" value="{{ old('price') }}" id="example-number-input">
                                @error('price')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-10">
                                <input name="offer_price" class="form-control m-input" type="number" value="{{ old('offer_price') }}" id="example-number-input">
                                @error('offer_price')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
