                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">تعديل التصنيف</h3>
                        </div>
                    </div>
                </div>
                <!--begin::Form-->
                <form method="post" action="{{ route('category.update',$category->id) }}" class="m-form m-form--fit m-form--label-align-right">
                    @csrf
                    @method('put')
