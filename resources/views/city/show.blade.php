                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">عرض المدينة</h3>
                        </div>
                    </div>
                </div>
                <!--begin::Form-->
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input" type="text" value="{{ $city->country->name }}"
                                       id="example-text-input" name="country_id">
                            </div>
                        </div>
                    </div>
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <a href="{{ route('city.edit',$city->id) }}" class="btn btn-success">تعديل</a>
